...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    try {
      ...
      meals = result.data
      mealsQueryError = result.error
    } catch (e) {
      console.log('[today-api] SUPABASE QUERY THREW:', e)
      throw e
    }
    if (mealsQueryError) console.log('[today-api] SUPABASE QUERY ERROR:', mealsQueryError)
